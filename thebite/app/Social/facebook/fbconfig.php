...
if(isset($_REQUEST['connect']) && $_REQUEST['connect'] == 1){
    $_SESSION['connect'] = 1;
}
//echo 'hiii';
//exit();

FacebookSession::setDefaultApplication( '183603575529710','2d8585226eb1d7ef60e9657ecf5f1cdb' );


// login helper with redirect_uri
    $helper = new FacebookRedirectLoginHelper('http://demo.imagetowebpage.com/food_ordering/app/Social/facebook/fbconfig.php' );
try {
	...
	/* ---- Session Variables -----*/
	    ...
	    $_SESSION['FB']['last_name'] =  $last_name;
            ...
            if(isset($_SESSION['connect']) && $_SESSION['connect'] == 1){
                header("Location: http://demo.imagetowebpage.com/food_ordering/fbconnect/");
                unset($_SESSION['connect']);
            }else{
                header("Location: http://demo.imagetowebpage.com/food_ordering/user/fblogin");
                exit;
            }
