...
FacebookSession::setDefaultApplication( '636876453167349','7bb0239a0ae0addc8b7c5cb5d2f6142f' );
// login helper with redirect_uri
    $helper = new FacebookRedirectLoginHelper('http://192.168.0.45/comp200/ubbergloves/site/app/webroot/facebook/fbconfig.php' );
try {
...
//            print_r($_SESSION);exit;
  ...
  header("Location: http://192.168.0.45/comp200/ubbergloves/site/users/fblogin/");
  exit;
