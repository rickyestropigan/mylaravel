                                ...
                                if (!$records->isEmpty()) {
                                    ...
                                    <div class="table_dcf">
                                        <div class="tr_tables">
                                            ...
                                            <div class="td_tables">Tax</div>
                                            <div class="td_tables">Delivery charge</div>
                                        ...
                                        foreach ($records as $data) {
                                            ...
                                            <div class="tr_tables2">
                                                ...
                                                <div data-title="Address Title" class="td_tables2">
                                                    {{ App::make("HomeController")->numberformat($data->tax,2) }}
                                                </div>
                                                <div data-title="Address Title" class="td_tables2">
                                                    {{  App::make("HomeController")->numberformat($data->delivery_charge,2) }}
                                                </div>
                                                <div data-title="Address Title" class="td_tables2">
                                                    {{ App::make("HomeController")->numberformat($data->discount,2) }}
                                                </div>
                                                <div data-title="Address Title" class="td_tables2">
                                                    
                                                    {{ App::make("HomeController")->numberformat($data->price + $data->delivery_charge + $data->tax - $data->discount ,2) }}
                                                </div>
                                                ...
                                                <div data-title="Action" class="td_tables2">
                                                    <div class="actions">
                                                        <?php
                                                        echo html_entity_decode(HTML::link('order/myorders/' . $data->slug, '<i class="fa fa-search"></i>', array('class' => 'btn btn-primary btn-xs', 'title' => 'View Order Details')));
                                                        ?>
                                                    </div>
                                                </div>	
                                            </div>
