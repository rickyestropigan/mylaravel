        ...
        <div class="right_wrap_inner">
            <div class="informetion informetion_new">
                <div class="informetion_top">
                    <div class="tatils"> <span class="personal">Add Offer</span></div>
                    <div class="pery">
                        ...
                        {{ Form::open(array('url' => '/offer/addoffer', 'method' => 'post', 'id' => 'myform', 'files' => true,'class'=>"cmxform form-horizontal tasi-form form")) }}
                        ...
                        <div class="form_group">    
                            ...
                            <div id="items" class="in_upt">
                                {{  Form::text('offer', Input::old("offer"),  array('class' => 'required form-control positiveNumber','id'=>"offer"))}}
                            </div>
                        ...
                        <div class="form_group selectt">
                            ...
                            <div class="in_upt">
                                <div class="dropp">
                                    ...
                                    ?>
                                    {{ Form::select('name', $cuisine_array, Input::old("name"), array('class' => 'form-control required', 'id'=>'offer_name')) }}
                                </div>
                            </div>
                        </div>

                        <div id="item_fieds_offer" style="display: none">
                            <div class="form_group">
                        ...
                        <div id="above_price" style="display: none">
                            <div class="form_group">
                                {{ HTML::decode(Form::label('above_price', "Above Price(".CURR.")<span class='require'>*</span>",array('class'=>"control-label col-lg-2"))) }}
                                <div class="in_upt">
                                    {{  Form::text('above_price', Input::old("above_price"),  array('class' => 'positiveNumber number form-control','id'=>"above_price"))}}
                                </div>
                        ...
                        <div class="form_group">
                            ...
                            <div class="in_upt">
                                {{  Form::textarea('note', Input::old("note"),  array('class' => 'form-control required','id'=>"note" ,"maxlength"=>"250"))}}
                            </div>
                        </div>
                        <div class="calendar_row">
                            <div class="form_group">
                                ...
                                <div class="radio_div">
                                    {{ Form::checkbox('days', 'All Day', FALSE, ['id' => 'days', 'class'=>'first-choice']) }}
                            ...
                            <div class="form_group">
                                ...
                                {{ Form::text('start_date', '', array('class' => 'required search_fields form-control searchDate','placeholder'=>"Start Date",'id'=>'searchByDateFrom',"data-date"=>"", "data-date-format"=>"yyyy-mm-dd", "data-link-field"=>"dtp_input2", "data-link-format"=>"yyyy-mm-dd",'onkeypress'=>"return false")) }}
                            </div>
                            <div class="form_group selectt offer_time_slot">
                                ...
                                <div class="dropp">
                                    ...
                                    ?>
                                    {{ Form::select('start_time', $start_time, Input::old("start_time"), array('class' => 'form-control required', 'id'=>'start_time')) }}
                                </div>

                            </div>
                            <div class="form_group">
                                <label class="sr-only" for="search_end">End Date</label>
                                {{ Form::text('end_date', '', array('class' => 'required search_fields form-control searchDate','placeholder'=>"End Date",'id'=>'searchByDateTo',"data-date"=>"", "data-date-format"=>"yyyy-mm-dd", "data-link-field"=>"dtp_input2", "data-link-format"=>"yyyy-mm-dd",'onkeypress'=>"return false")) }}
                            </div>
                            ...
                            <div class="form_group selectt offer_time_slot">
                                ...
                                <div class="dropp">
                                    ...
                                    {{ Form::select('end_time', $start_time, Input::old("end_time"), array('class' => 'form-control required', 'id'=>'end_time')) }}
                                </div>
                        ...
                        <div class="form_group">
                            ...
                            <div class="in_upt">
                                <?php
                                $offer_service = '';
                                $offer_service = explode(',', $userData->service_offered);
                                $ij=1;
                                foreach ($offer_service as $offer_services) {
                                    ?>

                                    <div class="radio">
                                        {{ Form::checkbox('service_visibility[]',$offer_services, FALSE, ['id' => 'first-choice'.$ij, 'class'=>'first-choice required']) }}
                        ...
                        <div class="form_group selectt">
                            ...
                            <div class="in_upt">
                                <div class="dropp">
                                    ...
                                    ?>
                                    {{ Form::select('allocate', $start_time, Input::old("allocate"), array('class' => 'form-control required', 'id'=>'allocate')) }}
                                </div>
                            </div>
                        </div>
...
//                 echo'<pre>'; print_r($records);
                ...
                <div class="form_group selectt">
                    ...
                    <div class="in_upt">
                        {{ Form::select('menu_items', $records, Input::old("menu_items"), array('multiple'=>'multiple','class' => 'form-control required items_popup', 'id'=>'menu_items')) }}
                    </div>
                </div>
                <div class="form_group input_bxxs">
                    <label>&nbsp;</label>
