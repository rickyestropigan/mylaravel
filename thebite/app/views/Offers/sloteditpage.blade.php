    ...
    <div class="modal-content">
        <div class="modal-body" >
            <div class="pop_form" style="text-align: center;">
                <div class="center_txt">Edit <?php echo $offerslotdetails->discount; ?> % OFF on Time <?php echo date('g:i A', strtotime($offerslotdetails->start_time)); ?> - <?php echo date('g:i A', strtotime($offerslotdetails->end_time)); ?></div>
                <span data-color="#4AD57A"  data-slot="<?php echo $offerslotdetails->id; ?>" data-offer="<?php echo $record->discount; ?>" data-obj="" class="changecolor" style="background:#4AD57A; "></span><div class="textt" style="margin-right: 20px;"><?php echo $record->discount; ?>% Off</div>

                <?php
                foreach ($color as $colorAtr) {
                    ?>
                    <span data-color="<?php echo $colorAtr['color']; ?>" data-slot="<?php echo $offerslotdetails->id; ?>" data-offer="<?php echo $colorAtr['offer']; ?>" data-obj="" class="changecolor" style="background:<?php echo $colorAtr['color']; ?>"></span>   
            ...
            <div class="pop_form">
                <div class="pop_field">
                    <label>offer</label> 
                    <div class="two_wrap">
                        <div class="input_filed">{{  Form::text('offer', $offerslotdetails->discount,  array('class' => 'required form-control positiveNumber number offervalid','id'=>"offer"))}}
...
//                 echo'<pre>'; print_r($records);
                                $exp = explode(',', $offerslotdetails->item_name);
                                ...
                                ?>
                                {{ Form::select('menu_items[]', $records, $exp, array('multiple'=>'multiple','onclick'=>'checkfunc(this);','id'=>'menu','class' => 'required')) }}
                ...
                <div class="pop_field">
                    ...
                    <div class="two_wrap">
                        <div class="input_filed">{{  Form::text('above_price', $offerslotdetails->above_price,  array('class' => 'number','id'=>"above_price"))}}<span class="sett" style="float: right;">$</span></div></div>
                </div>
                <?php
                $start_date = date('d/m/Y', strtotime($offerslotdetails->start_date));
                $end_date = date('d/m/Y', strtotime($offerslotdetails->end_date));
                ?>

                <div class="pop_field">
                    <label>No. of Coupons</label> 
                    <div class="two_wrap">
                        <div class="input_filed">{{ Form::text('coupon', $offerslotdetails->allocate, array('minlength'=>'1','maxlength'=>'2','class' => 'required number','id'=>'coupon','placeholder'=>"")) }}</div>
                    </div>
                    <div class="small_box"><a data-title="unlimited" class="unlimited" href="javascript:void('0')">Unlimited</a></div>
                    <?php
                    if ($offerslotdetails->allocate == 0) {
                        $unlimit = 1;
                    } else {
                        $unlimit = 0;
                    }
                ...
                <div class="pop_field">
                    ...
                    <input type="hidden" class="required" value="<?php echo $offerslotdetails->status; ?>" name="status" id="editvisibility" />
                </div>
                <div class="pop_field">
                    <label>Slot Color</label> 
                    <div class="two_wrap">
                        <?php if (!empty($offerslotdetails->color)) { ?>
                            {{ Form::text('color', $offerslotdetails->color, array('class' => '','id'=>'colorslot','placeholder'=>"")) }}
                        <?php } else { ?>
                ...
                <div class="pop_field">
                    ...
                    <div class="two_wrap">
                        <div class="input_filed textarea">
                            {{  Form::textarea('disclaimer', $offerslotdetails->disclaimer,  array('class' => 'form-control','id'=>"offerslotdatadiscla" ,"maxlength"=>"250"))}}
                            Disclaimer 
                        </div>
                    </div>
                </div>
                ...
                <div class="pop_btn full_btmn">
                    <input type="hidden" value="<?php echo $offerslotdetails->slug ?>" name="slug"/>
                              ...
                              //  console.log(color);
                                ...
                                $.ajax({
                                    ...
                                    if (suc == 'success') {
                                        ...
                                        $('#editOfferModal').hide();
                                        $(that).attr('style', 'background-color:' + (color + ' !important'));
