        ...
        <section class="product_listing mt-5" >
            <div class="container">
                <div class="row" id="final">
                    <?php $user_id = Session::get('userdata')->id;
                    if (!empty($filter)) {
...
<ul class="list-unstyled radio-toolbar ">
						 ...
						 <?php   
                                         ...
                                         if($res['offerstart'])
                                         {
                                            $start = date("h:i", strtotime($res['offerstart']));
                                            $end = date("h:i", strtotime($res['offerend']));
                                         }


                                         ?>
                                            <label for="discount"><span>{{$start}}</span>
                                                <b>{{$res['offerdis']}} % off</b>
                                            </label>
                                        </li>
                                        <li class="d-inline-block">
                                            <input type="radio" id="radioBanana" name="radioFruit" value="banana">
                                            <label for="radioBanana"><span>{{$end}}</span>
                                                <b>{{$res['offerdis']}} % off</b></label></li>
                ...
                <div class="row border-bottom pb-2">
                    ...
                    <div class="col-12 col-sm-12 col-lg-5 form-group">
                        <div class="b-select-wrap time_menu">
                            <i class="fa fa-clock-o"></i>
                            <input  type="text" name="time" class="timepicker form-control b-select text-center"  				placeholder="7:30 PM">
                        </div>
                        <div class="b-select-wrap date_menu">
                            <input  type="text" id="datepicker" class="form-control b-select text-center"  id="reservation-calendar" 						placeholder="Jan 20, 2019">
                            ...
                            <li class="fillter_icon d-inline-block"><a href="javascript:void(0)" class="filter_pop">{{ HTML::image("public/listingimg/fillter.png") }}</a>
                                <div class="filtter_option">
                                    <!--<form class="form-horizontal" role="form">-->
                                        ...
                                        <div class="form-group">
                                            <a href="{{ url('/listing') }}"><button type="button" id="btn" class="btn btn-primary border-0">Clear</button></a>  <button type="submit" class="btn btn-primary border-0" onClick="resfilter()">Apply</button></div>
                                ...
                                <div class="card-body px-0">
                                    ...
                                    <ul class="list-unstyled radio-toolbar ">
                                        <li class="d-inline-block">
                                            ...
                                            <input type="radio" id="discount" name="radioFruit" value="apple" checked>
                                            <label for="discount"><span>{{$res['offerslotstart_time']}}</span>
                                                <b>{{$res['offerslotdis']}} % off</b>
                                            </label>
                                        </li>
                                        <li class="d-inline-block">
                                            <input type="radio" id="radioBanana" name="radioFruit" value="banana">
                                            <label for="radioBanana"><span>{{$res['offerslotend_time']}}</span>
                                                <b>{{$res['offerslotdis']}} % off</b></label></li>
