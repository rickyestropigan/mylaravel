                    ...
                    <div class="ml-auto col-12 col-sm-12 col-md-3 col-lg-3">
                       ...
                       {?>  
                          ...
                          <?php }else {?>
                            ...
                            <?php }?>   
                             <li class="nav-item d-inline-block"><a href="#">Cart<span class="bag_cart">{{ HTML::image("public/frontimg/bag.png") }}<b class="cart_btn">1</b></span></a></li>   
                        </ul>
                    </div>
                </div>  
            </div>  
