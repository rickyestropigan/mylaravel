            ...
            case 0:
                ...
                if (!empty($search)) {
                    ...
                    foreach ($search as $data) {    
                        ...
                        if(($c_time >= $datahr[0]->start_time) && ($c_time <= $datahr[0]->end_time)){
                            ...
                            $output .= '
                                    ...
                                    '</a></li></ul>
                                                                    ...
                                                                    <li class="d-inline-block"><a href="">Min. Order  <i class="fa fa-inr"></i> ' . $data->minimum_order . '</a></li>
                                                                </ul>
                                                                <div class="validity">
                ...
                if (!empty($filter)) {
                    ...
                    foreach ($filter as $data) {
                        ...
                        $output .= '
                                                         ...
                                                         <div class="card br-0 custom_card border-0 mb-5">
                                                           <div class="card_img position-relative"> 
                                                          <div class="tag position-absolute">' . $data->discount . '% off on all menu</div>' . '<a href=' . '/wordpress/bitebargain/restaurantdetail/' . $data->userslug . '>' . $img . '</a>' .
                                '</div>' .
                                '<div class="card-body px-0">
